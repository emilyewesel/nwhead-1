...
def define_train_eval_metrics(train_method):
    ...
    if train_method == 'nwhead':
        list_of_val_metrics = [
            ...
            'balanced_acc:val:full:white',
            'balanced_acc:val:full:nonwhite',
            'balanced_acc:val:random:white',
            'balanced_acc:val:random:nonwhite',
            'balanced_acc:val:cluster:white',
            'balanced_acc:val:cluster:nonwhite',
            'balanced_acc:val:ensemble:white',
            'balanced_acc:val:ensemble:nonwhite',
            'balanced_acc:val:knn:white',
            'balanced_acc:val:knn:nonwhite',
            'balanced_acc:val:hnsw:white',
            'balanced_acc:val:hnsw:nonwhite',
